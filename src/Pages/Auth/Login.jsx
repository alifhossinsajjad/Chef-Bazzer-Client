      ...
      <div className="max-w-5xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row shadow-orange-100">
        ...
        <div className="w-full md:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
          <div className="text-center md:text-left mb-8">
            ...
            <p className="text-gray-500 mt-2">Please login to access your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit(handleLogin)} className="space-y-6">
            ...
            <div className="form-control">
              <label className="label flex justify-between">
                ...
                <a href="#" className="label-text-alt link link-hover text-orange-600 font-semibold" onClick={(e) => e.preventDefault()}>Forgot password?</a>
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                  <FaLock />
            ...
            <p className="text-center text-gray-600 mt-6">
              ...
              <Link to="/register" state={location.state} className="text-orange-600 font-bold hover:underline">
                Register
              </Link>
            </p>
          </form>
        ...
        <div className="hidden md:flex md:w-1/2 relative bg-gray-900">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center w-full h-full text-white p-12 text-center">
            ...
            <p className="text-lg">"Good food is the foundation of genuine happiness."</p>
            <div className="mt-8 p-4 bg-white/10 backdrop-blur-md rounded-lg border border-white/20">
              <p className="text-sm font-light italic">Join thousands of food lovers today.</p>
            </div>
          </div>
        </div>
