...
import { FaEye, FaEyeSlash, FaCloudUploadAlt, FaUser, FaEnvelope, FaLock, FaMapMarkerAlt } from "react-icons/fa";
  ...
  const handleRegister = async (data) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        if (dbRes.data.insertedId || dbRes.data.message === "User already exists") { // Adjust based on your backend response
      ...
      <div className="max-w-6xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="hidden md:flex md:w-1/2 relative bg-gray-900">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center w-full h-full text-white p-12 text-center">
            ...
            <p className="text-lg mb-8">Discover a world of culinary delights and fresh ingredients delivered to your door.</p>
        ...
        <div className="w-full md:w-1/2 p-8 lg:p-12">
          ...
          <form onSubmit={handleSubmit(handleRegister)} className="space-y-5">
                  ...
                  <input
                    ...
                    {...register("password", {
                      ...
                      pattern: {
                        ...
                        message: "Weak password (needs Upper, Lower, Number, Special)"
                      }
                    })}
            ...
            >
              {uploading ? <span className="loading loading-spinner"></span> : "Create Account"}
            </button>
