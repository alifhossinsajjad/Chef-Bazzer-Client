        ...
        <div className="container mx-auto px-4 py-8 mt-16">
                        ...
                        >
                            <div className="card-body">
                                ...
                                <div className="relative pl-6 py-2">
                                    ...
                                    <p className="text-gray-600 italic line-clamp-3 text-sm">{review.comment}</p>
                                </div>

                                <div className="text-xs text-gray-400 mt-2">
                                    {/* Assuming review has some date field, checking properties */}
                                    Posted on: {review.date ? new Date(review.date).toLocaleDateString() : "Unknown Date"}
                                </div>
            ...
            <dialog id="update_modal" className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    <h3 className="font-bold text-lg mb-4 text-orange-600">Update Review</h3>
                    {editingReview && (
                        <form onSubmit={handleUpdateSubmit} className="space-y-4">
                            ...
                            <div className="modal-action">
                                <form method="dialog">
                                    ...
                                    <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2" onClick={() => setEditingReview(null)}>✕</button>
                                </form>
                                <button type="submit" className="btn bg-orange-500 hover:bg-orange-600 text-white">Save Changes</button>
                            </div>
                        </form>
                    )}
                </div>
