                    ...
                    <div className="bg-gray-100 rounded-lg p-6 text-left space-y-4 shadow-inner">
                        ...
                        <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                            ...
                            <div className="text-right">
                                ...
                                <span
                                    className={`font-medium capitalize flex items-center gap-2 justify-end ${status === "active" ? "text-green-600" : "text-red-500"
                                        }`}
                                >
                                    {status === "active" ? (
                                        <FaCheckCircle />
                    ...
                    {status === "fraud" && (
                        <div className="mt-8 p-4 bg-red-50 border border-red-200 rounded-lg">
                            <p className="text-red-600 text-center font-semibold flex items-center justify-center gap-2">
                                <FaExclamationTriangle /> Your account has been marked as fraud. Role requests are disabled.
                            </p>
                        </div>
                    )}
                </div>
